    ...
    <div className="max-w-4xl mx-auto py-3 lg:py-6 animate-fadeIn pb-12 lg:pb-6 px-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 lg:gap-8">
        ...
        <div className="lg:col-span-8">
          ...
          <div className="w-full flex flex-col gap-3 lg:gap-6 mt-4 lg:mt-8 relative z-10 max-w-lg mx-auto">
            {renderFractionBar(n1, d1, isSameDenominator ? d2 : 1, 'bg-indigo-400')}
            
            <div className="flex justify-center my-1 lg:my-2 gap-3 lg:gap-4">
               {['<', '=', '>'].map((op) => (
                 <button 
                    key={op}
                    onClick={() => handleGuess(op as '<'|'>'|'=')}
                    className={`
                      w-10 h-10 lg:w-12 lg:h-12 rounded-xl font-bold text-xl lg:text-2xl font-mono shadow-sm transition-all active:scale-95
                      ${selectedOp === op 
        ...
        <div className={`lg:col-span-4 flex flex-col gap-3 lg:gap-4 ${mode === 'evaluate' ? 'opacity-50 pointer-events-none' : ''}`}>
            ...
            <div className="flex flex-col gap-2 lg:gap-3 mb-4 lg:mb-6">
              ...
              {SCENARIOS.map((s, idx) => (
                <button
                  ...
                  className={`
                    py-1.5 lg:py-2.5 px-3 lg:px-4 rounded-xl text-xs lg:text-sm font-bold text-left transition-all active:scale-95
          ...
          <div className="bg-amber-50 border border-amber-100 p-3 lg:p-6 rounded-2xl lg:rounded-3xl mt-1 lg:mt-4">
